...
app.get('/', (req, res) => {
	...
	con.connect((err) => {
		...
		con.query(sql, (err, results) => {
			...
			res.render("projectKiosk", {memberId: memberId, memberTel: memberTel, memberPoint: memberPoint, menuInfo: menuInfo, refillStuff: refillStuff, refillKind: refillKind, menuCategory: menuCategory, imgSrc: imgSrc, menuName: menuName, menuPrice: menuPrice});
		});
	});
});
